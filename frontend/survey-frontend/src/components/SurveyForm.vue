<template>
    <div class="survey-form">
      <div class="header-box mb-4">
        <h1><i class="fas fa-clipboard-list me-2"></i>Campus Visit Survey</h1>
      </div>
...
<div class="form-group mb-4">
          ...
          <div class="text-center">
            <button type="button" class="btn btn-secondary me-3" @click="resetForm">
  ...
  methods: {
    ...
    submitForm() {
      if (this.validateForm()) {
        ...
        SurveyService.createSurvey(formattedSurvey)
          .then(response => {
            alert(`Survey #${response.data.id} submitted successfully!`);
            this.resetForm();
